...
| body       | —      | —      | 14px | 1.71        | 0px            | `--text-body`       |
| heading-sm | —      | —      | 18px | 1.56        | 0px            | `--text-heading-sm` |
| heading    | —      | —      | 20px | 1.4         | 0px            | `--text-heading`    |
| heading-lg | —      | —      | 24px | 1.33        | 0px            | `--text-heading-lg` |
| display    | —      | —      | 32px | 1.25        | 0px            | `--text-display`    |
