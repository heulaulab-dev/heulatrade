...
export default function ForgotPasswordPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-black p-4">
      <section className="w-full max-w-[390px] border border-[var(--color-iron)] bg-[var(--color-carbon)] p-6" aria-label="Forgot password">
        ...
        <h1 className="mb-4 text-sm">RESET PASSWORD</h1>
        {!configured && (
